# Node.js Alexa Skill World Currencies

## Alexa Skills Kit Documentation
The documentation for the Alexa Skills Kit is available on the [Amazon Apps and Services Developer Portal](https://developer.amazon.com/appsandservices/solutions/alexa/alexa-skills-kit/).

## Contents
I used nodejs AWS Lambda functions as Alexa Skills to create a skill called WorldCurrencies.

This is my skill created based on the Alexa Skills Kit Sample called ReindeerGames
